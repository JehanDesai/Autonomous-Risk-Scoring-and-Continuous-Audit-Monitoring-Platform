...
class DataConnector:
    ...
    def extract_transactions(self, start_date: Optional[datetime] = None, end_date: Optional[datetime] = None, limit: int = 1000) -> pd.DataFrame:
    ...
    def _generate_synthetic_data(self, start_date: Optional[datetime] = None, end_date: Optional[datetime] = None, num_records: int = 1000) -> pd.DataFrame:
