...
class RiskScoringModel:
    ...
    def __init__(self, model_type: str = "isolation_forest", model_params: Optional[Dict] = None):
        ...
        self.categorical_features = ['department', 'expense_type', 'vendor', 
    ...
    def _create_preprocessor(self) -> ColumnTransformer:
        ...
        preprocessor = ColumnTransformer(
            transformers=[
                ('num', numeric_transformer, self.numeric_features + self.date_features),
    ...
    def predict_risk_scores(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        if self.model_type == "isolation_forest":
            ...
            risk_scores = 100 * (1 - (decision_scores - min(decision_scores)) / 
                              (max(decision_scores) - min(decision_scores)))
